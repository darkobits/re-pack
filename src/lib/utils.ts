...
import { readPackageUp, type NormalizedPackageJson } from 'read-package-up'
 ...
 */
export async function getPackageInfo(cwd: string = process.cwd()): Promise<PackageInfo> {
...
export async function temporarilyRemoveProblematicPackageScripts(pkgInfo: PackageInfo) {
